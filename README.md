...
Features:<br>
Task Management: Add, edit, delete and mark tasks as complete<br>. 
User-Friendly Interface: Simple command-line / GUI for easy interaction.<br>
Persistent Storage: Saves tasks for future tracking.<br>
...
Features:<br>
Basic Operations: Supports addition (+), <br>
subtraction (-),<br>
multiplication (*), <br>
division (/).<br>
...
Custom Complexity: Option to include letters, numbers, and special characters.<br>
Generate Password: Use a combination of random characters to generate a password of the specified length. <br>
Display the Password: Print the generated strong password on the screen.<br>
